...
print("\n")
print("Hello,"+" This is "+name, ". Currently I am doing my Bsc in CSE at "+university, " Which is located in Uttara."+" In this university, I am trying to maintain an average cgpa in every semester"+". My current cgpa is",cgpa, "My phone number is",phone, "and my gmail is",gmail, " Normaly for any problem mail me or You can call me directly in  emergency case")
